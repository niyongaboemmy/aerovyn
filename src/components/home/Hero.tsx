...
const nebulae = [
  {
    ...
    color:
      "radial-gradient(ellipse 55% 65% at 42% 48%, rgba(100,0,210,0.13) 0%, transparent 70%)",
    blur: 90,
    breathe: "24s",
    drift: "40s",
    bDelay: "0s",
  ...
  },
  {
    ...
    color:
      "radial-gradient(ellipse 60% 55% at 52% 46%, rgba(0,50,200,0.11) 0%, transparent 68%)",
    blur: 80,
    breathe: "30s",
    drift: "48s",
    bDelay: "7s",
  ...
  },
  {
    ...
    color:
      "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(0,180,155,0.06) 0%, transparent 65%)",
    blur: 100,
    breathe: "20s",
    drift: "52s",
    bDelay: "11s",
  ...
  },
  {
    ...
    color:
      "radial-gradient(ellipse 52% 62% at 50% 50%, rgba(200,0,100,0.07) 0%, transparent 65%)",
    blur: 85,
    breathe: "27s",
    drift: "44s",
    bDelay: "15s",
  ...
  },
  {
    ...
    color:
      "radial-gradient(ellipse 58% 52% at 48% 50%, rgba(185,100,0,0.06) 0%, transparent 62%)",
    blur: 95,
    breathe: "22s",
    drift: "56s",
    bDelay: "19s",
        ...
        >
          <div
            style={{
              ...
              borderRadius: 2,
              background:
                "linear-gradient(to right, transparent, rgba(200,235,255,0.9) 35%, #fff 55%, rgba(200,235,255,0.3) 80%, transparent)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          d="M -60 340 Q 760 -60 1540 460"
          stroke="rgba(0,245,196,0.035)"
          strokeWidth="1"
        />
        <path
          d="M -80 620 Q 500 200 1520 700"
          stroke="rgba(0,245,196,0.025)"
          strokeWidth="0.8"
        />
        <path
          d="M 200 -40 Q 900 320 1480 120"
          stroke="rgba(0,245,196,0.028)"
          strokeWidth="0.8"
        />
        ...
        <circle
          ...
          cy="340"
          r="2.5"
          fill="rgba(0,245,196,0.55)"
          style={{ filter: "drop-shadow(0 0 4px rgba(0,245,196,0.7))" }}
        />
        {/* Extra faint cross-arcs */}
        <path
          d="M 1540 200 Q 600 500 -60 800"
          stroke="rgba(0,245,196,0.018)"
          strokeWidth="0.6"
          strokeDasharray="6 14"
        />
        <path
          d="M 400 -20 Q 1100 450 300 920"
          stroke="rgba(0,245,196,0.016)"
          strokeWidth="0.6"
...
function AsteroidSVG({ size }: { size: number }) {
  ...
  return (
    <svg width={s} height={s} viewBox={`0 0 ${s} ${s}`} fill="none">
      <polygon
        points={pts}
        fill="rgba(155,135,110,0.55)"
        stroke="rgba(200,180,150,0.28)"
        strokeWidth="0.7"
      />
      <polygon
        points={`${s * 0.35},${s * 0.2} ${s * 0.65},${s * 0.18} ${s * 0.72},${s * 0.5} ${s * 0.48},${s * 0.62} ${s * 0.28},${s * 0.52}`}
      ...
      {ASTEROIDS.map((a, i) => (
        <div key={i} className="absolute" style={{ top: a.top, left: a.left }}>
          <div
            data-ast={String(i)}
            style={{
              animation: `asteroid-cross-${i} ${a.speed} linear ${a.delay} infinite`,
            }}
          >
        ...
        <div style={{ animation: "comet-streak 12s linear 45s infinite" }}>
          <svg width="80" height="8" viewBox="0 0 80 8" fill="none">
            ...
            <circle
              ...
              style={{
                filter: "blur(1px) drop-shadow(0 0 4px rgba(200,235,255,1))",
              }}
            />
          </svg>
        </div>
...
const DATA_COLUMNS = [
  ...
  { left: "87%", opacity: 0.05, dur: "24s", delay: "8s" },
];
    ...
    >
      {DATA_COLUMNS.map((col, i) => (
        <div
          ...
          style={{ left: col.left, width: 12, opacity: col.opacity }}
        >
          <pre
            style={{
...
function EarthGlobe({
  ...
  return (
    <div
      style={{ width: EARTH_SIZE, height: EARTH_SIZE, position: "relative" }}
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 68% 50%, transparent 35%, rgba(0,0,5,0.72) 80%, rgba(0,0,5,0.92) 100%)",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 42% 38% at 30% 28%, rgba(220,240,255,0.13) 0%, transparent 60%)",
          }}
        />
      </div>
    </div>
    ...
    >
      ...
      <g filter={`url(#dg-glow-${size})`}>
        ...
        {motors.map(({ cx, cy, spin, led }) => (
          <g key={`m${cx}${cy}`}>
            <ellipse
              ...
              rx={18}
              ry={18}
              fill="rgba(0,245,196,0.05)"
              stroke="rgba(0,245,196,0.18)"
              strokeWidth="6"
              filter={`url(#dg-rotor-${size})`}
            />
            <g className={spin}>
              <line
                x1={cx - 16}
            ...
            {led && (
              <circle
                ...
                r="2"
                fill="#00F5C4"
                style={{ animation: "led-blink 2.4s ease-in-out infinite" }}
              />
            )}
          </g>
        ))}
        <rect
          ...
          height="28"
          rx="5"
          fill="rgba(0,245,196,0.07)"
          stroke="rgba(0,245,196,0.5)"
          strokeWidth="1.2"
        />
        <line
          x1="80"
...
function OrbitDrone() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (svgWrap)
        gsap.to(svgWrap, {
          rotationY: Math.max(-22, Math.min(22, -dx * 22)),
          duration: 0.35,
          overwrite: "auto",
        });
    };
...
function SurfaceDrone({
  ...
  useEffect(() => {
    ...
    const quickX = gsap.quickTo(drone, "x", {
      duration: 6.0,
      ease: "power1.out",
    });
    const quickY = gsap.quickTo(drone, "y", {
      duration: 6.0,
      ease: "power1.out",
    });
    const quickRY = gsap.quickTo(svgWrap!, "rotationY", {
      duration: 1.2,
      ease: "power1.out",
    });
...
const SKY_DRONE_SEEDS = [
  ...
  { id: 3, sx: 0.76, sy: 0.64, scale: 0.5, opacity: 0.4, speed: 0.6 },
];
...
function SkyDrone({
  ...
  useEffect(() => {
    ...
    waypoints.forEach((wp) => {
      ...
      tl.to(
        drone,
        { x: wp.x, y: wp.y, duration: dur, ease: "sine.inOut" },
        "<0.2",
      );
      if (svgWrap)
        tl.to(
          svgWrap,
          { rotationY: bankY, duration: dur * 0.3, ease: "power1.inOut" },
          "<",
        );
    });
    tl.to(drone, {
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {altitudeBands.map(({ top, label, opacity }, i) => (
        ...
        >
          <div
            ...
            style={{
              background: `rgba(0,245,196,${opacity})`,
              animation: `alt-shimmer ${7 + i * 1.3}s ease-in-out ${i * 0.7}s infinite`,
            }}
          />
          <span
            className="ml-3 mr-4 shrink-0 select-none"
            style={{
              fontFamily: "var(--font-orbitron)",
              fontSize: 9,
              color: `rgba(0,245,196,${opacity + 0.03})`,
      ...
      >
        ...
        {headingTicks.map((tick, i) => (
          <span
            ...
            style={{
              fontFamily: "var(--font-orbitron)",
              fontSize: 8,
              color: i === 1 ? "#00F5C4" : "rgba(0,245,196,0.18)",
              letterSpacing: "0.1em",
            }}
          >
            {tick}
        ...
        <div
          ...
          style={{
            left: `calc(${(1 / 12) * 100}% + 2.5rem)`,
            width: 1,
            height: 6,
            background: "#00F5C4",
            boxShadow: "0 0 6px rgba(0,245,196,0.8)",
          }}
        />
      </div>
      {[0, 1.4, 2.8].map((delay) => (
        <div
          ...
          style={{
            ...
            width: 180,
            height: 180,
            borderColor: "rgba(0,245,196,0.09)",
            animation: `radar-pulse 5.5s ease-out ${delay}s infinite`,
          }}
        />
      ))}
      <HudBracket corner="tl" />
      <HudBracket corner="tr" />
      <HudBracket corner="bl" />
      <HudBracket corner="br" />
      {[20, 40, 60, 80].map((left) => (
        <div
          key={left}
          className="absolute top-0 bottom-0 w-px"
          style={{ left: `${left}%`, background: "rgba(0,245,196,0.013)" }}
        />
      ))}
    </div>
  );
...
const PLANETS = [
  {
    ...
    c2: "#7a3c14",
    ring: true,
    ringColor: "rgba(200,160,80,0.32)",
    glowColor: "rgba(200,140,60,0.13)",
    dur: "80s",
    del: "0s",
  },
  {
  ...
  },
  {
    ...
    ring: false,
    ringColor: "",
    glowColor: "rgba(36,110,220,0.13)",
    dur: "72s",
    del: "14s",
  },
  {
    ...
    c2: "#200844",
    ring: true,
    ringColor: "rgba(130,70,200,0.26)",
    glowColor: "rgba(100,52,180,0.13)",
    dur: "92s",
    del: "22s",
  },
];
...
const LEFT_MSGS = [
  ...
  "WIND 3KT NE, STABLE",
  "TELEMETRY TX OK",
  "LOG ENTRY #4821 SAVED",
];
const RIGHT_MSGS = [
  "ACK WAYPOINT_04",
  "SECTOR BOUNDARY CLEAR",
  "ORBIT-02 ON SCHEDULE",
  "DRONE-02 NOMINAL",
  "WIND +3KTS NE",
  "AIRSPACE CLASS-D CLEAR",
  "RELAY LINK STABLE",
  "NO TRAFFIC DETECTED",
          ...
          >
            ...
            <span
              style={{
                ...orb,
                fontSize: 7.5,
                color: msgColors[Math.min(msg.age, 6)],
...
function DroneCameraPanel({ onOpen }: { onOpen: () => void }) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setTelem((prev) => {
        const newAlt = Math.min(
          1300,
          Math.max(1200, prev.alt + Math.floor(Math.random() * 9) - 4),
        );
        const newSpd = parseFloat(
          Math.min(
            15,
            Math.max(10, prev.spd + (Math.random() * 0.8 - 0.4)),
          ).toFixed(1),
        );
        const newHdg =
          (prev.hdg + Math.floor(Math.random() * 5) - 2 + 360) % 360;
        const newLat = parseFloat(
          (prev.lat + (Math.random() * 0.000024 - 0.000012)).toFixed(6),
        );
        const newLon = parseFloat(
          (prev.lon + (Math.random() * 0.000024 - 0.000012)).toFixed(6),
        );
        return {
          alt: newAlt,
          spd: newSpd,
    ...
    const statusInterval = setInterval(() => {
      ...
      setTelem((prev) => ({
        ...prev,
        status: STATUS_CYCLE[statusIdxRef.current],
      }));
    }, 7000);
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 3,
        boxShadow:
          "0 0 30px rgba(0,245,196,0.07), inset 0 0 20px rgba(0,245,196,0.03)",
        cursor: "pointer",
      ...
      onMouseEnter={(e) => {
        ...
        el.style.boxShadow =
          "0 0 40px rgba(0,245,196,0.18), inset 0 0 20px rgba(0,245,196,0.06)";
    ...
    >
      ...
      >
        ...
        <div
          ...
          `,
            transform:
              "perspective(180px) rotateX(38deg) translateY(18px) scaleX(1.4)",
        ...
        <div
          style={{
            ...
            height: 24,
            background:
              "linear-gradient(to bottom, transparent, rgba(0,245,196,0.08) 40%, transparent)",
          }}
        />
        ...
        <div
          style={{
            ...
            left: "38%",
            background:
              "radial-gradient(ellipse, rgba(0,245,196,0.12) 0%, transparent 70%)",
            filter: "blur(8px)",
            borderRadius: "50%",
          }}
        />
        ...
        <div
          style={{
            ...
            height: 2,
            background:
              "linear-gradient(to right, transparent, rgba(0,245,196,0.3) 20%, rgba(0,245,196,0.45) 50%, rgba(0,245,196,0.3) 80%, transparent)",
        ...
        >
          ...
          <text
            ...
            y="14"
            style={{
              ...(orbitron as React.CSSProperties),
              fontSize: 6,
              fill: "rgba(0,245,196,0.35)",
            }}
          >
            ALT VIEW
          </text>
          ...
          {/* Scan range arcs */}
          <path
            d="M 20 130 Q 141 60 262 130"
            stroke="rgba(0,245,196,0.07)"
            strokeWidth="0.8"
            fill="none"
          />
          <path
            d="M 40 130 Q 141 80 242 130"
            stroke="rgba(0,245,196,0.05)"
            strokeWidth="0.6"
            fill="none"
          />
        </svg>
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 6,
            borderTop: "1px solid rgba(0,245,196,0.07)",
            paddingTop: 4,
          }}
        >
          <span
          ...
          <span
            style={{
              ...orbitron,
              fontSize: 8,
              color: telem.status === "SIGNAL LOCK" ? "#00d68f" : "#00F5C4",
              letterSpacing: "0.1em",
            }}
          >
            {telem.status}
          ...
          <span
            style={{
              ...
              borderRadius: "50%",
              background:
                telem.status === "ACQUIRING..." ? "#ffb800" : "#00F5C4",
              boxShadow: `0 0 6px ${telem.status === "ACQUIRING..." ? "#ffb800" : "#00F5C4"}`,
  ...
  return (
    ...
    >
            ...
            animation:
              [
                s.twinkle
                  ...
                  : "",
                s.drift
                  ? `star-drift ${s.driftDur}s ease-in-out ${s.driftDelay}s infinite`
                  : "",
              ]
                .filter(Boolean)
                .join(", ") || undefined,
      ...
      >
        {audioOn ? (
          <>
            <span style={{ animation: "live-pulse 1.2s ease-in-out infinite" }}>
              ◉
            </span>{" "}
            AIRSPACE AUDIO
          </>
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-2 pb-24 pt-[50vh] text-center md:pb-0 md:pt-0">
        {/* Badge — desktop only */}
        <p
          className="hero-badge mb-4 hidden text-xs font-semibold uppercase tracking-[0.35em] text-[#00F5C4] md:inline-block"
        ...
        <h1
          className="mb-5 flex flex-wrap justify-center gap-0 text-[clamp(2.2rem,9vw,8rem)] font-black leading-none tracking-widest md:mb-6"
          style={{ fontFamily: "var(--font-orbitron)", perspective: "600px" }}
          aria-label={HEADLINE}
        >
          {chars.map((char, i) =>
            char === " " ? (
